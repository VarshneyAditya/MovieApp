...
function Search(props) {
  ...
  return (
    <div class="flex">
        ...
        <input value={displayMovieCounter} onChange={(e)=>DisplayMovieCounterHandler(e)}  class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mr-2"  type="number" placeholder="Select" ></input>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-1 rounded focus:outline-none focus:shadow-outline" >Search</button>
    </div>
  )
}
